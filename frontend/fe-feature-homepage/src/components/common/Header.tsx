...
import {ShoppingCart, User, Search, Rocket} from 'lucide-react';
        ...
        <header
            ...
            <div className="flex flex-col w-full px-6 py-4 max-w-screen-2xl mx-auto">
                <div className="flex items-center justify-between gap-8 mb-4">
                    <Link to="/" className="flex items-center gap-2 text-3xl font-black tracking-tighter text-primary">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/cart"
                            ...
                            <ShoppingCart className="text-primary w-6 h-6 group-hover:scale-110 transition-transform"/>
                            {itemCount > 0 && (
                                <span className="absolute top-0 right-0 w-4 h-4 bg-error text-red-600 text-[10px] flex items-center justify-center rounded-full font-bold">
                                    {itemCount}
                                </span>
                            )}
                        </Link>
                ...
                <nav
                    ...
                    <Link to="/" className="text-primary font-bold border-b-2 border-primary pb-1 whitespace-nowrap">Trang
                        chủ</Link>
                    <Link to="#"
                          className="text-slate-600 hover:text-primary transition-all duration-300 whitespace-nowrap">Hàng
                        mới</Link>
                    <Link to="#"
                          className="text-slate-600 hover:text-primary transition-all duration-300 whitespace-nowrap">Hướng
                        dẫn</Link>
                    <Link to="#"
                          className="text-slate-600 hover:text-primary transition-all duration-300 whitespace-nowrap">Dịch
                        vụ</Link>
                    <Link to="#"
                          className="text-slate-600 hover:text-primary transition-all duration-300 whitespace-nowrap">Mô
                        hình Custom</Link>
                </nav>
            </div>
        </header>
