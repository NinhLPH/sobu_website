...
export default function ZaloChatDock() {
    ...
    return (
        <div aria-label="Thanh chat Zalo" className="flex flex-col items-end gap-3">
            {isOpen && (
                <section
                        ...
                        {!hasPageId ? (
                            <div className="flex h-full flex-col items-center justify-center rounded-xl border border-outline-variant/30 bg-surface-container-low px-5 text-center">
                                ...
                                <p className="mt-2 max-w-[18rem] text-xs font-semibold leading-relaxed text-outline">
                                    Dang cho cau hinh Zalo OA/pageId.
                                </p>
                                {zaloUrl && (
                                    <a
                                        href={zaloUrl}
                            ...
                            <div className="flex h-full flex-col items-center justify-center rounded-xl border border-outline-variant/30 bg-surface-container-low px-5 text-center">
                                <MessageCircle className="mb-3 h-8 w-8 text-primary"/>
                                <p className="text-sm font-black text-on-surface">Khong tai duoc Zalo chat</p>
                                {zaloUrl ? (
                                    <a
                                        href={zaloUrl}
                                        target="_blank"
                                    ...
                                    <p className="mt-2 text-xs font-semibold text-outline">Vui long thu lai sau.</p>
                                )}
                            </div>
                        ) : (
                            <>
                                {sdkStatus !== 'loaded' && (
                                    <div className="absolute inset-3 z-10 flex items-center justify-center rounded-xl bg-surface-container-lowest/90 text-xs font-bold text-outline backdrop-blur-sm">
                                        <Loader2 className="mr-2 h-4 w-4 animate-spin text-primary"/>
                                        Dang tai Zalo...
                                    </div>
                                )}
                                <div className="flex h-full items-center justify-center rounded-xl border border-outline-variant/25 bg-surface-container-low">
                                    <div
