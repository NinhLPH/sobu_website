        ...
        >
            <div className="flex flex-1 animate-pulse flex-col justify-between rounded-xl bg-surface-container p-3">
                <div className="space-y-2">
                    <div className="h-2 w-16 rounded-full bg-outline-variant/35"/>
                    <div className="h-2 w-24 rounded-full bg-outline-variant/35"/>
                </div>
                <div className="flex flex-col items-center gap-3 text-center">
                    <div className="h-16 w-16 rounded-2xl bg-outline-variant/35"/>
                    <span className="text-[10px] font-black uppercase tracking-[0.16em] text-outline">
                        {label}
                    </span>
                </div>
                <div className="space-y-2">
                    <div className="h-2 w-full rounded-full bg-outline-variant/35"/>
                    <div className="h-2 w-2/3 rounded-full bg-outline-variant/35"/>
                </div>
            </div>
        </div>
    );
