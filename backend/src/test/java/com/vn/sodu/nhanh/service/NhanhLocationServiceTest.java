...
class NhanhLocationServiceTest {
    ...
    void setUp() {
        ...
        locationService = new NhanhLocationService(store);
    }

    @Test
    void readsFromSnapshotStore() {
    ...
    void throwsWhenStoreIsEmpty() {
        ...
        assertThrows(LocationDataUnavailableException.class, () -> locationService.getLocations());
    }
}
